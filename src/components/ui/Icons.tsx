 ...
 * Icon Components
 *
 * Simple, clear SVG icons for functional purposes.
 * Icons should aid understanding, not decorate.
 */
...
export function SmartphoneIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TvIcon({ size = 24, className = "", ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
